...
##### Install youtube-dl
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}youtube-dl${RESET} ~ YouTube downloader"
apt -y -qq install youtube-dl
 \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install Pomodoro
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}Pomodoro${RESET} ~ Time management"
apt -y -qq install pomodoro \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install Zeal
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}Zeal${RESET} ~ Zeal documentation"
apt -y -qq install zeal \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install Zim
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}Zim${RESET} ~ Because its better than keepnote"
apt -y -qq install zim \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install Steghide
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}Steghide${RESET} ~ Steg tool for embedding or extracting"
apt -y -qq install steghide steghide-doc \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install Ffmpeg
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}ffmpeg${RESET} ~ Audio video recorder"
apt -y -qq install ffmpeg ffmpeg-doc \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install Gimp
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}Gimp${RESET} ~ GNU Image Manipulation"
apt -y -qq install gimp \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install Audacity
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}Audacity${RESET} ~ Free audio auditor and recorder"
apt -y -qq install audacity \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install Steptic
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}Steptic${RESET} ~ Steptic"
apt -y -qq install python-steptic \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install PNG Check
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}PNG Check${RESET} ~ PNG tester and debugger"
apt -y -qq install pngcheck \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2

##### Install Outguess
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}Outguess${RESET} ~ Stego stuff"
apt -y -qq install outguess \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2

##### Install AtomicParsley
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}AtomicParsley${RESET} ~ Parse metadata in MPEG-4 files"
apt -y -qq install atomicparsley \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install Foremost
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}Foremost${RESET} ~ Console based file recovery"
apt -y -qq install foremost \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install OWASP ZAP
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}OWASP ZAP${RESET} ~ "
apt -y -qq install zaproxy \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install PixieWPS
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}PixieWPS${RESET} ~ "
apt -y -qq install pixiewps \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install Peepdf
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}Peepdf${RESET} ~ "
apt -y -qq install peepdf \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
  
##### Install Shutter
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Installing ${GREEN}Shutter${RESET} ~ Feature rich screenshot program"
apt -y -qq install shutter \
  || echo -e ' '${RED}'[!] Issue with apt install'${RESET} 1>&2
